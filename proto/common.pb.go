...
type Pager struct {
	...
	Page_Size            int64    `protobuf:"varint,2,opt,name=page_Size,json=pageSize,proto3" json:"page_Size,omitempty"`
...
func (m *Pager) GetPage_Size() int64 {
	if m != nil {
		return m.Page_Size
	}
	return 0
...
var fileDescriptor_1747d3070a2311a0 = []byte{
	...
	0x04, 0xa3, 0x02, 0xa3, 0x06, 0x73, 0x10, 0x98, 0x2d, 0x24, 0xcd, 0xc5, 0x09, 0xa2, 0xe3, 0x83,
	0x33, 0xab, 0x52, 0x25, 0x98, 0xc0, 0x12, 0x1c, 0x20, 0x01, 0x10, 0x5f, 0x48, 0x96, 0x8b, 0xab,
	0x24, 0xbf, 0x24, 0x31, 0x27, 0xbe, 0x28, 0xbf, 0xbc, 0x58, 0x82, 0x19, 0x2c, 0xcb, 0x09, 0x16,
	0x09, 0xca, 0x2f, 0x2f, 0x4e, 0x62, 0x03, 0x9b, 0x6f, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x4d,
	0xb6, 0x3f, 0xc9, 0x7c, 0x00, 0x00, 0x00,
}
